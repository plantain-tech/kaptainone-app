    ...
    <div class="booking-card">
        ...
        <div>
            ...
            <div class="booking-breakdown">
                ...
                <span>Rental: <?= e(number_format((float) $booking['total_amount_pln'] - (float) $booking['deposit_snapshot_pln'], 0)) ?> PLN · Deposit: <?= e(number_format((float) $booking['deposit_snapshot_pln'], 0)) ?> PLN</span>
                <span>Total due at approval: <?= e(number_format((float) $booking['total_amount_pln'], 0)) ?> PLN</span>
                <span>Owner: <?= e($ownerFirst) ?> · Pickup district: <?= e($booking['location_district']) ?></span>
            </div>
            <?php if ($booking['courier_message']): ?><div class="booking-card__message"><?= nl2br(e($booking['courier_message'])) ?></div><?php endif; ?>
            <?php if ($booking['owner_response_message']): ?><div class="booking-card__message"><strong>Owner note:</strong><br><?= nl2br(e($booking['owner_response_message'])) ?></div><?php endif; ?>
        </div>
    </div>
</section>
