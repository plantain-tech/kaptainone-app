...
<header class="admin-top"><div><h1>Equipment</h1><p class="text-muted" style="margin-top:0.25rem;">Kaptain-owned assets</p></div><a href="dashboard.php" class="btn btn-secondary">Dashboard</a></header>
